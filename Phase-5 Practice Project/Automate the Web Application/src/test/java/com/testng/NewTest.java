...
public class NewTest {
	...
	private void addDetailsToLoginForm() throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"fname\"]")).sendKeys("Prem");
		driver.findElement(By.xpath("//*[@id=\"email\"]")).sendKeys("");
		driver.findElement(By.xpath("//*[@id=\"pass\"]")).sendKeys("prem123");
	...
	private void addDetailToRegisterForm() throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"email\"]")).sendKeys("Prem@gmail.com");
		driver.findElement(By.xpath("//*[@id=\"psw\"]")).sendKeys("prem123");
		driver.findElement(By.xpath("//*[@id=\"psw-repeat\"]")).sendKeys("Nandy");
